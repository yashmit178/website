                ...
                attachments=[
                    {
                        ...
                        "fields": [
                            ...
                            {"title": "Volume", "value": f"{quote.volume:,}", "short": True,},
                            {
                                "title": "Open",
                            ...
                            {"title": "Low", "value": f"${quote.low:,.4f}", "short": True,},
                            {"title": "High", "value": f"${quote.high:,.4f}", "short": True,},
                        ],
    ...
    if message["type"] == "app_mention":
        try:
            await request.app["slack_client"].query(
                ...
                data={"name": "sirbot", "channel": message["channel"], "timestamp": message["ts"],},
            )
